...
def _settings_path() -> str:
    ...
    It assumes that this module is in src/server/bootstrap and removes
...
# SETTINGS_PATH is computed once the first time this module is loaded
...
def main() -> list[Settings]:
    ...
    logger.debug("Settings: %s", settings_objects)
